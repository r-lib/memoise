...
* Improved compressions options via [`qs`](https://github.com/traversc/qs).
  Optional impacts to the memory cache (uses less memory) and all filesystem 
  caches (faster and uses less space) (#100 - @rhjp)
